...
namespace Language_tr {
  ...
  LSTR MSG_MEDIA_INIT_FAIL                = _UxGT(" Init Fail");
  ...
  LSTR MSG_START_PRINT                    = _UxGT("Baskı Başlat");
  ...
  LSTR MSG_BUTTON_IGNORE                  = _UxGT("Göz ardı et");
  ...
  LSTR MSG_ADVANCED_PAUSE                 = _UxGT("Gelişmiş Duraklama");
  ...
  LSTR MSG_CONTINUE_PRINT_JOB             = _UxGT("Baskıyı Sürdür");
  ...
  LSTR MSG_PLEASE_WAIT                    = _UxGT("Bekleyiniz...");
  LSTR MSG_PLEASE_RESET                   = _UxGT("Lütfen Resetleyin");
  LSTR MSG_PREHEATING                     = _UxGT("Ön ısınıyor...");
