...
//  #define CASE_LIGHT_PIN P2_06                  // Override the default pin if needed    ***SUTAS SKR V1.3 P2_04***
...
#define INPUT_SHAPING
  ...
  #define SHAPING_FREQ_X    19  // (Hz) The dominant resonant frequency of the X axis.
  #define SHAPING_FREQ_Y    55  // (Hz) The dominant resonant frequency of the Y axis.
...
//    #define POWER_LOSS_BATTERY_PIN P1_28
//    #define POWER_LOSS_BATTERY_ACTIVE_STATE HIGH
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  60     //homing speed 20
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70     //homing speed 20
...
//#define G0_FEEDRATE 7200 // (mm/min)
#ifdef G0_FEEDRATE
