...
//  #define CASE_LIGHT_PIN P2_04                  // Override the default pin if needed    ***SUTAS SKR V1.3 P2_04***
...
#define HOMING_BUMP_MM      { 0, 0, 10 }       // (mm) Backoff from endstops after first bump
